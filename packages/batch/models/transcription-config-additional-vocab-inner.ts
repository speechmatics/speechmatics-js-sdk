 ...
 *
 * @export
 * @interface TranscriptionConfigAdditionalVocabInner
 */
export interface TranscriptionConfigAdditionalVocabInner {
  /**
   *
   * @type {string}
   * @memberof TranscriptionConfigAdditionalVocabInner
   */
  content: string;
  /**
   *
